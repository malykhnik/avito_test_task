# Сервис проведение тендеров
## Проблема:
Авито большая компания, на которой не только продают/покупают товары/услуги пользователи. Но также компании/бизнесы/предприятия используют Авито, которые тоже нуждаются в услугах.
...
Предложения могут создавать пользователи либо от имени своейорганизации.
